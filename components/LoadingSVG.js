export default function LoadingSVG({width = "2em", styles}) {
  return (
    <svg style={styles} className="loading" width={width} xmlns="http://www.w3.org/2000/svg" fill="#000" viewBox="0 0 120 30">
