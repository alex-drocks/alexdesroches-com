    ...
    >
      <div className="max-content-width display-flex">
        <section className="max-text-width">
          ...
          <p>
            Je suis un passionné de programmation, cinéma, jeux vidéos, musique, composition musicale, théologie et
            philosophie. Bref, à peu près tout ce qui éveil mon côté créatif et nourri mon imagination.
          </p>
          <p>
            Je suis dans la trentaine, habitant au Canada dans la province du Québec, avec ma chère épouse Cathy
            et bientôt notre premier né&nbsp;!
          </p>
          <p>
          ...
          <p>
            J'ai une personnalité de travailleur&nbsp;: persévérant, passionné et orienté sur l'excellence. Je n'aime
            pas
            l'échec et je fais mon mieux à chaque défi pour réussir à bien faire. Quand j'échoue, je le prend
            difficilement, mais çà me propulse vers d'autres niveaux de persévérance. Ce que j'aime encore moins que
            l'échec, est l'abandon. Pour moi, abandonner est le véritable échec. Alors, je m'efforce constamment à
            progresser plutôt qu'à me résigner à la défaite.
            Tout ce que je fais, je le fais de mon mieux et je trouve
            des solutions pour améliorer mon environnement de travail.
          </p>
          <p>
            Avec moi, vous pouvez vous attendre au professionnalisme et à l'excellence de mon travail. Je donne toujours
            le meilleur de moi-même peu importe la responsabilité.
          </p>
        </section>
